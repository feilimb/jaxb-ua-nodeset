...
/**
 * &lt;p&gt;Java class for ListOfDatagramConnectionTransportDataType complex type&lt;/p&gt;.
 * 
...
public class ListOfDatagramConnectionTransportDataType {
     ...
     * This is why there is not a {@code set} method for the datagramConnectionTransportDataType property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the datagramConnectionTransportDataType property.
     */
    public List<DatagramConnectionTransportDataType> getDatagramConnectionTransportDataType() {
        if (datagramConnectionTransportDataType == null) {
            datagramConnectionTransportDataType = new ArrayList<>();
        }
