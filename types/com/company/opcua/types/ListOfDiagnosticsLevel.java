...
/**
 * &lt;p&gt;Java class for ListOfDiagnosticsLevel complex type&lt;/p&gt;.
 * 
...
public class ListOfDiagnosticsLevel {
     ...
     * This is why there is not a {@code set} method for the diagnosticsLevel property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the diagnosticsLevel property.
     */
    public List<DiagnosticsLevel> getDiagnosticsLevel() {
        if (diagnosticsLevel == null) {
            diagnosticsLevel = new ArrayList<>();
        }
