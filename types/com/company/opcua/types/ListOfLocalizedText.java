...
/**
 * &lt;p&gt;Java class for ListOfLocalizedText complex type&lt;/p&gt;.
 * 
...
public class ListOfLocalizedText {
     ...
     * This is why there is not a {@code set} method for the localizedText property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the localizedText property.
     */
    public List<LocalizedText> getLocalizedText() {
        if (localizedText == null) {
            localizedText = new ArrayList<>();
        }
