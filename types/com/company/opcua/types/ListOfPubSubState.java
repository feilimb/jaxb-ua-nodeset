...
/**
 * &lt;p&gt;Java class for ListOfPubSubState complex type&lt;/p&gt;.
 * 
...
public class ListOfPubSubState {
     ...
     * This is why there is not a {@code set} method for the pubSubState property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the pubSubState property.
     */
    public List<PubSubState> getPubSubState() {
        if (pubSubState == null) {
            pubSubState = new ArrayList<>();
        }
