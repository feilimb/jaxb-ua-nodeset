...
/**
 * &lt;p&gt;Java class for ListOfPublishedDataSetDataType complex type&lt;/p&gt;.
 * 
...
public class ListOfPublishedDataSetDataType {
     ...
     * This is why there is not a {@code set} method for the publishedDataSetDataType property.</p>
     * 
     * <p>
    ...
    public List<PublishedDataSetDataType> getPublishedDataSetDataType() {
        if (publishedDataSetDataType == null) {
            publishedDataSetDataType = new ArrayList<>();
        }
