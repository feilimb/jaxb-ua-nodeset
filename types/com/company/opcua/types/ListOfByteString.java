...
/**
 * &lt;p&gt;Java class for ListOfByteString complex type&lt;/p&gt;.
 * 
...
public class ListOfByteString {
     ...
     * This is why there is not a {@code set} method for the byteString property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the byteString property.
     */
    public List<byte[]> getByteString() {
        if (byteString == null) {
            byteString = new ArrayList<>();
        }
