...
/**
 * &lt;p&gt;Java class for ListOfEnumField complex type&lt;/p&gt;.
 * 
...
public class ListOfEnumField {
     ...
     * This is why there is not a {@code set} method for the enumField property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the enumField property.
     */
    public List<EnumField> getEnumField() {
        if (enumField == null) {
            enumField = new ArrayList<>();
        }
