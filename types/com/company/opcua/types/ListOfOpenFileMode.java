...
/**
 * &lt;p&gt;Java class for ListOfOpenFileMode complex type&lt;/p&gt;.
 * 
...
public class ListOfOpenFileMode {
     ...
     * This is why there is not a {@code set} method for the openFileMode property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the openFileMode property.
     */
    public List<OpenFileMode> getOpenFileMode() {
        if (openFileMode == null) {
            openFileMode = new ArrayList<>();
        }
