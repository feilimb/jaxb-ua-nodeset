...
/**
 * &lt;p&gt;Java class for ListOfUserTokenPolicy complex type&lt;/p&gt;.
 * 
...
public class ListOfUserTokenPolicy {
     ...
     * This is why there is not a {@code set} method for the userTokenPolicy property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the userTokenPolicy property.
     */
    public List<UserTokenPolicy> getUserTokenPolicy() {
        if (userTokenPolicy == null) {
            userTokenPolicy = new ArrayList<>();
        }
