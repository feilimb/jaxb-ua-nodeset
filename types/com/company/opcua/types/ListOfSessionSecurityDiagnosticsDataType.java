...
/**
 * &lt;p&gt;Java class for ListOfSessionSecurityDiagnosticsDataType complex type&lt;/p&gt;.
 * 
...
public class ListOfSessionSecurityDiagnosticsDataType {
     ...
     * This is why there is not a {@code set} method for the sessionSecurityDiagnosticsDataType property.</p>
     * 
     * <p>
    ...
    public List<SessionSecurityDiagnosticsDataType> getSessionSecurityDiagnosticsDataType() {
        if (sessionSecurityDiagnosticsDataType == null) {
            sessionSecurityDiagnosticsDataType = new ArrayList<>();
        }
