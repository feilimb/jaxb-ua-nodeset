...
/**
 * &lt;p&gt;Java class for ListOfBrokerDataSetWriterTransportDataType complex type&lt;/p&gt;.
 * 
...
public class ListOfBrokerDataSetWriterTransportDataType {
     ...
     * This is why there is not a {@code set} method for the brokerDataSetWriterTransportDataType property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the brokerDataSetWriterTransportDataType property.
     */
    public List<BrokerDataSetWriterTransportDataType> getBrokerDataSetWriterTransportDataType() {
        if (brokerDataSetWriterTransportDataType == null) {
            brokerDataSetWriterTransportDataType = new ArrayList<>();
        }
