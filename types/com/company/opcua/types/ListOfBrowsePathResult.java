...
/**
 * &lt;p&gt;Java class for ListOfBrowsePathResult complex type&lt;/p&gt;.
 * 
...
public class ListOfBrowsePathResult {
     ...
     * This is why there is not a {@code set} method for the browsePathResult property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the browsePathResult property.
     */
    public List<BrowsePathResult> getBrowsePathResult() {
        if (browsePathResult == null) {
            browsePathResult = new ArrayList<>();
        }
