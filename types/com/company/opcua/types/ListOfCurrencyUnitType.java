...
/**
 * &lt;p&gt;Java class for ListOfCurrencyUnitType complex type&lt;/p&gt;.
 * 
...
public class ListOfCurrencyUnitType {
     ...
     * This is why there is not a {@code set} method for the currencyUnitType property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the currencyUnitType property.
     */
    public List<CurrencyUnitType> getCurrencyUnitType() {
        if (currencyUnitType == null) {
            currencyUnitType = new ArrayList<>();
        }
