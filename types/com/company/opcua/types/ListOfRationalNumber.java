...
/**
 * &lt;p&gt;Java class for ListOfRationalNumber complex type&lt;/p&gt;.
 * 
...
public class ListOfRationalNumber {
     ...
     * This is why there is not a {@code set} method for the rationalNumber property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the rationalNumber property.
     */
    public List<RationalNumber> getRationalNumber() {
        if (rationalNumber == null) {
            rationalNumber = new ArrayList<>();
        }
