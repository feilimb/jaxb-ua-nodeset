...
/**
 * &lt;p&gt;Java class for ListOfThreeDVector complex type&lt;/p&gt;.
 * 
...
public class ListOfThreeDVector {
     ...
     * This is why there is not a {@code set} method for the threeDVector property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the threeDVector property.
     */
    public List<ThreeDVector> getThreeDVector() {
        if (threeDVector == null) {
            threeDVector = new ArrayList<>();
        }
