...
/**
 * &lt;p&gt;Java class for ListOfThreeDFrame complex type&lt;/p&gt;.
 * 
...
public class ListOfThreeDFrame {
     ...
     * This is why there is not a {@code set} method for the threeDFrame property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the threeDFrame property.
     */
    public List<ThreeDFrame> getThreeDFrame() {
        if (threeDFrame == null) {
            threeDFrame = new ArrayList<>();
        }
