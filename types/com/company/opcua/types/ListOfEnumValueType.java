...
/**
 * &lt;p&gt;Java class for ListOfEnumValueType complex type&lt;/p&gt;.
 * 
...
public class ListOfEnumValueType {
     ...
     * This is why there is not a {@code set} method for the enumValueType property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the enumValueType property.
     */
    public List<EnumValueType> getEnumValueType() {
        if (enumValueType == null) {
            enumValueType = new ArrayList<>();
        }
