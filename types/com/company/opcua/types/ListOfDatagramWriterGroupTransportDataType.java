...
/**
 * &lt;p&gt;Java class for ListOfDatagramWriterGroupTransportDataType complex type&lt;/p&gt;.
 * 
...
public class ListOfDatagramWriterGroupTransportDataType {
     ...
     * This is why there is not a {@code set} method for the datagramWriterGroupTransportDataType property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the datagramWriterGroupTransportDataType property.
     */
    public List<DatagramWriterGroupTransportDataType> getDatagramWriterGroupTransportDataType() {
        if (datagramWriterGroupTransportDataType == null) {
            datagramWriterGroupTransportDataType = new ArrayList<>();
        }
