...
/**
 * &lt;p&gt;Java class for ListOfAddNodesResult complex type&lt;/p&gt;.
 * 
...
public class ListOfAddNodesResult {
     ...
     * This is why there is not a {@code set} method for the addNodesResult property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the addNodesResult property.
     */
    public List<AddNodesResult> getAddNodesResult() {
        if (addNodesResult == null) {
            addNodesResult = new ArrayList<>();
        }
