...
/**
 * &lt;p&gt;Java class for ListOfServerOnNetwork complex type&lt;/p&gt;.
 * 
...
public class ListOfServerOnNetwork {
     ...
     * This is why there is not a {@code set} method for the serverOnNetwork property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the serverOnNetwork property.
     */
    public List<ServerOnNetwork> getServerOnNetwork() {
        if (serverOnNetwork == null) {
            serverOnNetwork = new ArrayList<>();
        }
