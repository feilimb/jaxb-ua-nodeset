...
/**
 * &lt;p&gt;Java class for ListOfNodeReference complex type&lt;/p&gt;.
 * 
...
public class ListOfNodeReference {
     ...
     * This is why there is not a {@code set} method for the nodeReference property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the nodeReference property.
     */
    public List<NodeReference> getNodeReference() {
        if (nodeReference == null) {
            nodeReference = new ArrayList<>();
        }
