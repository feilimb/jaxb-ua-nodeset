...
/**
 * &lt;p&gt;Java class for ListOfAddNodesItem complex type&lt;/p&gt;.
 * 
...
public class ListOfAddNodesItem {
     ...
     * This is why there is not a {@code set} method for the addNodesItem property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the addNodesItem property.
     */
    public List<AddNodesItem> getAddNodesItem() {
        if (addNodesItem == null) {
            addNodesItem = new ArrayList<>();
        }
