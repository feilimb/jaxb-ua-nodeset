...
/**
 * &lt;p&gt;Java class for ListOfReadValueId complex type&lt;/p&gt;.
 * 
...
public class ListOfReadValueId {
     ...
     * This is why there is not a {@code set} method for the readValueId property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the readValueId property.
     */
    public List<ReadValueId> getReadValueId() {
        if (readValueId == null) {
            readValueId = new ArrayList<>();
        }
