...
/**
 * &lt;p&gt;Java class for ListOfBrowsePath complex type&lt;/p&gt;.
 * 
...
public class ListOfBrowsePath {
     ...
     * This is why there is not a {@code set} method for the browsePath property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the browsePath property.
     */
    public List<BrowsePath> getBrowsePath() {
        if (browsePath == null) {
            browsePath = new ArrayList<>();
        }
