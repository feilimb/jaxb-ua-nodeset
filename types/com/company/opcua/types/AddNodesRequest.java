...
/**
 * &lt;p&gt;Java class for AddNodesRequest complex type&lt;/p&gt;.
 * 
...
@XmlType(name = "AddNodesRequest", propOrder = {
    "requestHeader",
    "nodesToAdd"
})
public class AddNodesRequest {
    ...
    @XmlElementRef(name = "NodesToAdd", namespace = "http://opcfoundation.org/UA/2008/02/Types.xsd", type = JAXBElement.class, required = false)
    protected JAXBElement<ListOfAddNodesItem> nodesToAdd;
     ...
     * @return
     *     possible object is
     *     {@link JAXBElement }{@code <}{@link ListOfAddNodesItem }{@code >}
     *     
     */
    public JAXBElement<ListOfAddNodesItem> getNodesToAdd() {
        return nodesToAdd;
    }
     ...
     *     
     */
    public void setNodesToAdd(JAXBElement<ListOfAddNodesItem> value) {
