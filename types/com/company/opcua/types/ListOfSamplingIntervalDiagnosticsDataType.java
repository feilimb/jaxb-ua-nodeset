...
/**
 * &lt;p&gt;Java class for ListOfSamplingIntervalDiagnosticsDataType complex type&lt;/p&gt;.
 * 
...
public class ListOfSamplingIntervalDiagnosticsDataType {
     ...
     * This is why there is not a {@code set} method for the samplingIntervalDiagnosticsDataType property.</p>
     * 
     * <p>
    ...
    public List<SamplingIntervalDiagnosticsDataType> getSamplingIntervalDiagnosticsDataType() {
        if (samplingIntervalDiagnosticsDataType == null) {
            samplingIntervalDiagnosticsDataType = new ArrayList<>();
        }
