...
/**
 * &lt;p&gt;Java class for ListOfPubSubDiagnosticsCounterClassification complex type&lt;/p&gt;.
 * 
...
public class ListOfPubSubDiagnosticsCounterClassification {
     ...
     * This is why there is not a {@code set} method for the pubSubDiagnosticsCounterClassification property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the pubSubDiagnosticsCounterClassification property.
     */
    public List<PubSubDiagnosticsCounterClassification> getPubSubDiagnosticsCounterClassification() {
        if (pubSubDiagnosticsCounterClassification == null) {
            pubSubDiagnosticsCounterClassification = new ArrayList<>();
        }
