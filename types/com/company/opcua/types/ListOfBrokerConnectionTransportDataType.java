...
/**
 * &lt;p&gt;Java class for ListOfBrokerConnectionTransportDataType complex type&lt;/p&gt;.
 * 
...
public class ListOfBrokerConnectionTransportDataType {
     ...
     * This is why there is not a {@code set} method for the brokerConnectionTransportDataType property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the brokerConnectionTransportDataType property.
     */
    public List<BrokerConnectionTransportDataType> getBrokerConnectionTransportDataType() {
        if (brokerConnectionTransportDataType == null) {
            brokerConnectionTransportDataType = new ArrayList<>();
        }
