...
/**
 * &lt;p&gt;Java class for ListOfBrowsePathTarget complex type&lt;/p&gt;.
 * 
...
public class ListOfBrowsePathTarget {
     ...
     * This is why there is not a {@code set} method for the browsePathTarget property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the browsePathTarget property.
     */
    public List<BrowsePathTarget> getBrowsePathTarget() {
        if (browsePathTarget == null) {
            browsePathTarget = new ArrayList<>();
        }
