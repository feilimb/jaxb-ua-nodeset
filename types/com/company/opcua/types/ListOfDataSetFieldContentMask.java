...
/**
 * &lt;p&gt;Java class for ListOfDataSetFieldContentMask complex type&lt;/p&gt;.
 * 
...
public class ListOfDataSetFieldContentMask {
     ...
     * This is why there is not a {@code set} method for the dataSetFieldContentMask property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the dataSetFieldContentMask property.
     */
    public List<Long> getDataSetFieldContentMask() {
        if (dataSetFieldContentMask == null) {
            dataSetFieldContentMask = new ArrayList<>();
        }
