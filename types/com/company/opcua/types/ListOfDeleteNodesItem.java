...
/**
 * &lt;p&gt;Java class for ListOfDeleteNodesItem complex type&lt;/p&gt;.
 * 
...
public class ListOfDeleteNodesItem {
     ...
     * This is why there is not a {@code set} method for the deleteNodesItem property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the deleteNodesItem property.
     */
    public List<DeleteNodesItem> getDeleteNodesItem() {
        if (deleteNodesItem == null) {
            deleteNodesItem = new ArrayList<>();
        }
