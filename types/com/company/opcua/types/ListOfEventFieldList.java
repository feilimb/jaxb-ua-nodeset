...
/**
 * &lt;p&gt;Java class for ListOfEventFieldList complex type&lt;/p&gt;.
 * 
...
public class ListOfEventFieldList {
     ...
     * This is why there is not a {@code set} method for the eventFieldList property.</p>
     * 
     * <p>
     ...
     * 
     * @return
     *     The value of the eventFieldList property.
     */
    public List<EventFieldList> getEventFieldList() {
        if (eventFieldList == null) {
            eventFieldList = new ArrayList<>();
        }
